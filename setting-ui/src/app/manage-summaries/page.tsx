...
const MangeSummaries = () => {
  ...
  const handleClearSummaries = async () => {
    try {
      await Api.delete(URL_SUMMARIZE_HISTORY);
      message.success("All summaries cleared successfully");
      fetchMessages(1); // Refresh the list after clearing
    } catch (error) {
      message.error("Error clearing summaries");
    }
  };
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="mb-5.5">
                    ...
                    <div className="flex items-end justify-between">
                      ...
                      <Button
                        className="bg-danger p-3 font-medium text-gray hover:bg-opacity-90"
